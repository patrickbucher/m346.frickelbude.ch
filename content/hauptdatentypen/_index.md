...
viele Felder es in dieser Tabelle gibt, wie diese Felder heissen, was für einen
...
### Repräsentation: Datenstruktur beim Programmieren
...
### Repräsentation: Zugriff via REST-Schnittstelle
...
### Repräsentation: Relationale Datenbank
...
verweist auf eine Person") gelöst. Zum Zweck der Eindeutigkeit werden die
Entitäten um künstliche `id`-Attribute ergänzt, die mithlfe einer Sequenz
...
- Mithilfe von `select` kann eine Reihe von Merkmalen aufgelistet werden, die
  ...
  die Differenz vom Eintrittsdatum (`since`) zum aktuellen Tagesdatum zur
